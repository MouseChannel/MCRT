...
public:
    ...
    void Make_Layout(std::vector<vk::DescriptorSetLayout> descriptorSetLayout, int pc_size, vk::ShaderStageFlags push_stage);
    void Make_Layout(std::initializer_list<std::shared_ptr<DescriptorSet>> descriptorSets, int pc_size, vk::ShaderStageFlags push_stage);

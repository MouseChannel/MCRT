...
void main()
{
    ...
    // left or right
    if (gl_InstanceCustomIndexEXT == 1 || gl_InstanceCustomIndexEXT == 3) {
        vec3 out_dir = reflect(gl_WorldRayDirectionEXT, cur_world_normal);
        prd.origin = cur_world_pos;
        prd.direction = out_dir;

...
void DescriptorSet::Update(vk::AccelerationStructureKHR acceleration_structure, uint32_t binding_index, vk::DescriptorType descriptor_type)
{
    vk::WriteDescriptorSetAccelerationStructureKHR dst_as_info;
    dst_as_info.setAccelerationStructureCount(1)
        .setAccelerationStructures(acceleration_structure);

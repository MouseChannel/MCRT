...
Compute_Pipeline::Compute_Pipeline()
{
    ...
    auto descriptor_layout = Descriptor_Manager::Get_Singleton()->Get_DescriptorSet_layout(Descriptor_Manager::Compute);

    // auto layout_create_info = vk::PipelineLayoutCreateInfo().setPSetLayouts(&descriptor_layout);
    std::vector<vk::DescriptorSetLayout> descriptor_layouts {
        descriptor_layout = Descriptor_Manager::Get_Singleton()->Get_DescriptorSet_layout(Descriptor_Manager::Compute)

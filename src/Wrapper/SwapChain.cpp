...
namespace MCRT {
    ...
    SwapChain::SwapChain() {
        ...
        auto share_mode = graphic_queue_index == present_queue_index ? vk::SharingMode::eExclusive
    ...
    vk::Extent2D
    SwapChain::Query_surface_Extent(const vk::SurfaceCapabilitiesKHR &capability, int windowWidth,
                                    int windowHeight) {
